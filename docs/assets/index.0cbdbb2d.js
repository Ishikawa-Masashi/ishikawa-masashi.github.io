...
import { R as React, B as BrowserRouter, r as react, C as Card, a as CardContent, T as Typography, b as CardActions, c as Button, s as styled, P as Paper, G as Grid, u as useRoutes, d as useNavigate, e as Box, f as CssBaseline, A as AppBar, g as Toolbar, D as Drawer, h as Divider, L as List, i as ListSubheader, j as ListItem, k as ListItemIcon, l as default_1, m as default_1$1, n as ListItemText, o as ListItemButton, p as default_1$2, q as default_1$3, t as Collapse, v as default_1$4, O as Outlet, w as ReactDOM } from "./vendor.24007a29.js";
...
const BasicCard = (props) => {
  ...
  return /* @__PURE__ */ react.exports.createElement(Card, {
    ...
    variant: "h5",
    component: "div"
  }, title)), /* @__PURE__ */ react.exports.createElement(CardActions, null, /* @__PURE__ */ react.exports.createElement(Button, {
    size: "small"
  }, "Learn More")));
};
...
const App$1 = () => {
  ...
  const createListItem = (name, path, index2) => /* @__PURE__ */ React.createElement(ListItem, {
    button: true,
    key: name,
  ...
  }, /* @__PURE__ */ React.createElement(ListItemIcon, null, index2 % 2 === 0 ? /* @__PURE__ */ React.createElement(default_1, null) : /* @__PURE__ */ React.createElement(default_1$1, null)), /* @__PURE__ */ React.createElement(ListItemText, {
    primary: name
  }));
  const createSubListItem = (name, path, index2) => /* @__PURE__ */ React.createElement(ListItemButton, {
    sx: { pl: 4 }
  }, /* @__PURE__ */ React.createElement(ListItemIcon, null, /* @__PURE__ */ React.createElement(default_1$4, null)), /* @__PURE__ */ React.createElement(ListItemText, {
    primary: name,
    onClick: () => {
      navigate(path);
  ...
  return /* @__PURE__ */ React.createElement(Box, {
  ...
  }, "Index"), homePages.map((page, index2) => createListItem(page.name, page.path, index2))), /* @__PURE__ */ React.createElement(List, null, /* @__PURE__ */ React.createElement(ListItemButton, {
    onClick: handleClick
    ...
    primary: "Games"
  }), open ? /* @__PURE__ */ React.createElement(default_1$2, null) : /* @__PURE__ */ React.createElement(default_1$3, null)), /* @__PURE__ */ React.createElement(Collapse, {
    in: open,
    timeout: "auto",
    unmountOnExit: true
